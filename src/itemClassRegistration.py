...
import weapons, potions, food, identifyer, containers, armor
...
defs = {"item": BasicitemFuncMaker(items.Item),
        ...
        "container": BasicitemFuncMaker(containers.Container, RE_STATIC_ARGS, RE_NORMAL_ARGS, (
              ("item capacity", TYPE_INT, "item_capacity"), ("weight capacity", TYPE_INT, "weight_capacity"),
              ("starting items", TYPE_ITEM_PROB, "startinginv"))),
        "key": BasicitemFuncMaker(items.Key),
        "armor": BasicitemFuncMaker(armor.Armor, RE_STATIC_ARGS, RE_NORMAL_ARGS, (("defence", TYPE_TUPLE_FLOAT),
                                                                                  ("slot", TYPE_STRING))
                                    )
        }
